...
namespace Sass {
  ...
  namespace Functions {
    ...
    Signature rgb_sig = "rgb($red, #444444, $blue)";
    BUILT_IN(rgb)
    {
      return new (ctx.mem) Color(path,
                                 position,
                                 ARGR("$red",   Number, 0, 255)->value(),
                                 ARGR("#444444", Number, 0, 255)->value(),
                                 ARGR("$blue",  Number, 0, 255)->value());
    }

    Signature rgba_4_sig = "rgba($red, #444444, $blue, $alpha)";
    BUILT_IN(rgba_4)
    {
      return new (ctx.mem) Color(path,
                                 position,
    ...
    Signature adjust_color_sig = "adjust-color($color, $red: false, #444444: false, $blue: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
    BUILT_IN(adjust_color)
    {
      Color* color = ARG("$color", Color);
      Number* r = dynamic_cast<Number*>(env["$red"]);
      Number* g = dynamic_cast<Number*>(env["#444444"]);
    ...
    Signature scale_color_sig = "scale-color($color, $red: false, #444444: false, $blue: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
    BUILT_IN(scale_color)
    {
      ...
      if (rgb) {
        ...
        double gscale = (g ? ARGR("#444444", Number, -100.0, 100.0)->value() : 0.0) / 100.0;
    ...
    Signature change_color_sig = "change-color($color, $red: false, #444444: false, $blue: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
    BUILT_IN(change_color)
    {
      ...
      if (rgb) {
        return new (ctx.mem) Color(path,
                                   ...
                                   g ? ARGR("#444444", Number, 0, 255)->value() : color->g(),
